...
%generative per-method HQMP plots for NED-D? put them all in one page
%cite number of methods per catalog?
% important to add to appendix supplementary figures to complement the multi-method analysis for hyperleda, all ned-d and cosmicflows. 
%say that we made new data tables?
% create plots for those tables. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
